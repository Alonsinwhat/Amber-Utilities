...
package net.mcreator.alonsinwhatmod.gui;
...
import net.mcreator.alonsinwhatmod.procedure.ProcedureMelting;
import net.mcreator.alonsinwhatmod.ElementsAmberUtilities;
import net.mcreator.alonsinwhatmod.AmberUtilities;
...
public class GuiMelterGUI extends ElementsAmberUtilities.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiMelterGUI(ElementsAmberUtilities instance) {
		super(instance, 19);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 37, 23) {
				@Override
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 69, 37) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 37, 53) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 116, 37) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				AmberUtilities.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("amberutils:textures/meltergui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Melter", 70, 8, -16777216);
		}
		...
		protected void actionPerformed(GuiButton button) {
			AmberUtilities.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				ProcedureMelting.executeProcedure($_dependencies);
			}
		}
